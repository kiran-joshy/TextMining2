...
tweets1<-searchTwitter("BernieSanders + election2020", n=200, lang=NULL, since=NULL, until=NULL, locale=NULL, geocode=NULL, sinceID=NULL, maxID=NULL,resultType=NULL, retryOnRateLimit=120)
tweets2<-searchTwitter("BernieSanders+ Covid19", n=200, lang=NULL, since=NULL, until=NULL, locale=NULL, geocode=NULL, sinceID=NULL, maxID=NULL, resultType=NULL, retryOnRateLimit=120)
tweets3<-searchTwitter("BernieSanders+ President", n=200, lang=NULL, since=NULL, until=NULL, locale=NULL, geocode=NULL, sinceID=NULL, maxID=NULL, resultType=NULL, retryOnRateLimit=120)
...
write.csv(tweets1, file="BernieSanders+election2020.csv")
write.csv(tweets2, file="BernieSanders+Covid19.csv")
write.csv(tweets3, file="BernieSanders+President.csv")

'''
9 files
1.trump- 1.election2020
        2.Covid19
         3.USPolitics
2.Joe- 1.election2020
         2.Covid19
         3.USPolitics
3.Bernie-1.election2020
         2.Covid19
         3.USPolitics
